...
{if ("" != null) return mods;}
  ...
  final private JClassDeclaration classDeclaration(ArrayList<String> mods) throws ParseException {int line = 0;
    ...
    ArrayList<TypeName> implementsL = null;
    TypeName implement = null;
    try {
...
name = token.image;
      ...
      case IMPLEMENTS:{
        ...
        implement = qualifiedIdentifier();
implementsL = new ArrayList<TypeName>();
implementsL.add(implement);
        label_5:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case COMMA:{
...
{if ("" != null) return new JClassDeclaration(line, mods, name, superClass, implementsL, classBody);}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return members;}
  ...
  final private JMember memberDecl(ArrayList<String> mods) throws ParseException {int line = 0;
    ...
    TypeName test1 = null;
    ArrayList<TypeName> test = null;//new ArrayList<TypeName>();
...
line = token.beginLine;
        ...
        case THROWS:{
          ...
          test1 = qualifiedIdentifier();
test = new ArrayList<TypeName>();
test.add(test1);
          label_9:
          while (true) {
            switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
test.add(test1);
        ...
        body = block();
memberDecl = new JConstructorDeclaration(line, mods, name, params, test, body);
...
memberDecl = new JMethodDeclaration(line, mods, name, type, params, test, body);
      } else {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case BOOLEAN:
        case CHAR:
...
{if ("" != null) return statement;}
  ...
  final private JStatement statement() throws ParseException {int line = 0;
    ...
    //Arraylist for the Switch Statement
   ArrayList<SwitchStatementGroup> stmtGroup = new ArrayList<SwitchStatementGroup>();
   SwitchStatementGroup grp = null;

   //try catch question 13
...
line = token.beginLine;
        ...
        while (true) {
          ...
          grp = switchBlockStatementGroup();
stmtGroup.add(grp);
        }
        jj_consume_token(RCURLY);
statement = new JSwitchStatement(line, expr,stmtGroup );
        break;
        }
      case THROW:{
...
{if ("" != null) return expr;}
  ...
  final private ArrayList<JStatement> forInit() throws ParseException {ArrayList<JStatement> checking1 = new ArrayList<JStatement>();
    Type type = null;

    JStatement statmnt = null;
    ArrayList <JVariableDeclarator> vDecl = new ArrayList<JVariableDeclarator>();
    int line = 0;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case FALSE:
      ...
      case LONG_LITERAL:
      case DOUBLE_LITERAL:{
        statmnt = statementExpression();
checking1.add(statmnt);
        label_16:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case COMMA:{
...
checking1.add(new JVariableDeclaration(line, vDecl));
        break;
        }
      default:
        jj_la1[38] = jj_gen;
...
{if ("" != null) return checking1;}
    throw new Error("Missing return statement in function");
}

  final private ArrayList<JStatement> forUpdate() throws ParseException {ArrayList<JStatement> checking1 = new ArrayList<JStatement>();
    JStatement statmnt = null;
    try {
      statmnt = statementExpression();
checking1.add(statmnt);
...
{if ("" != null) return checking1;}
  ...
  final private SwitchStatementGroup switchBlockStatementGroup() throws ParseException {ArrayList<JExpression> switchLabels = new ArrayList<JExpression>();
    ArrayList<JStatement> blocks = new ArrayList<JStatement>();
...
{if ("" != null) return new SwitchStatementGroup(switchLabels, blocks);}
    throw new Error("Missing return statement in function");
}
...
lhs = new JConditionalExpression(line, lhs, rhs, expr);
      }
    } catch (ParseException e) {
recoverFromError(new int[] { SEMI, EOF }, e);
    }
  ...
  private boolean jj_3R_70()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x2000000,0x100000,0x5c009000,0x5c009000,0x5c001000,0x5c001000,0x20000,0x0,0x0,0x0,0x20000,0x5c407000,0x5c407000,0x0,0x0,0x406000,0x0,0x0,0x0,0x406000,0x406000,0x0,0x0,0x0,0x406000,0xa1cc6000,0xa18c0000,0x81840000,0x81c46000,0x81840000,0x81840000,0x0,0x0,0x0,0xa18c0000,0x0,0x406000,0x0,0x81c46000,0x0,0x0,0xa1cc6000,0x0,0x0,0x0,0x81840000,0x0,0x81840000,0x0,0x81840000,0x406000,0x406000,0x0,0x0,0x406000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x200000,0x200000,0x0,0x0,0x0,0x0,0x0,0x0,0x81840000,0x0,0x81840000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x81840000,0x406000,0x0,0x0,0x0,0x1040000,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x0,0x0,0x4000,0x4000,0x0,0x0,0x0,0x100000,0x2000,0x100000,0x0,0x8404,0x8404,0x100000,0x40000,0x8404,0x100000,0x40000,0x10800000,0x8400,0x8404,0x100000,0x40000,0x10800000,0x8400,0x518b969b,0x518b129b,0x41000003,0x41008403,0x41000003,0x41000003,0x120,0x40,0x800,0x518b129b,0x100000,0x8400,0x100000,0x41008403,0x100000,0x120,0x518b969b,0x120,0x100000,0x20000000,0x41800003,0x100000,0x41800003,0x100000,0x41000003,0x8400,0x8400,0x400000,0x400000,0x8400,0x20000000,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x41000003,0x0,0x1000003,0x600000,0x40000000,0x40000000,0x1000000,0x600000,0x1000000,0x1000000,0x1200000,0x1000000,0x1000003,0x8400,0x800000,0x1000000,0x400000,0x2,};
	}
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x872,0x872,0x872,0x872,0x872,0x872,0x0,0x0,0x0,0x872,0x0,0x0,0x0,0x872,0x0,0x0,0x872,0x0,0x0,0x0,0x872,0x0,0x872,0x0,0x872,0x0,0x0,0x0,0x0,0x0,0x5255c080,0x5255c080,0x200,0x80000000,0x4,0x20000000,0x8000000,0x0,0x1000,0x1000,0x4800009,0x4800009,0x1280000,0x1280000,0x60,0x60,0x22100,0x22100,0x872,0x810,0x0,0x0,0x2,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x4,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x0,0x4,0x3704,0x3704,0x3704,0x3704,0x3704,0x3704,0x0,0x0,0x0,0x3704,0x0,0x4,0x0,0x3704,0x0,0x0,0x3704,0x0,0x0,0x0,0x3704,0x0,0x3704,0x0,0x3704,0x0,0x0,0x0,0x0,0x4,0x2,0x2,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3704,0x0,0x3704,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3704,0x4,0x0,0x0,0x0,0x3700,};
	}
