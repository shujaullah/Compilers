...
class JClassDeclaration extends JAST implements JTypeDecl {
    ...
    public void codegen(CLEmitter output) {
        ...
        ArrayList<String> checkingTypeClass = new ArrayList<>();
        if(superInterfaces != null) {
        for (TypeName i : superInterfaces) {
            checkingTypeClass.add(i.jvmName());
        }


        }
        output.addClass(mods, qualifiedName, superType.jvmName(), checkingTypeClass, false);
//        else
//            output.addClass(mods, qualifiedName, superType.jvmName(), null, false);
