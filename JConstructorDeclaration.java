...
class JConstructorDeclaration extends JMethodDeclaration implements JMember {
    ...
    public JAST analyze(Context context) {
        ...
        for (JFormalParameter param : params) {
            ...
            defn.initialize();
            // i change that according  to file.
        ...
        //jvmNames = new ArrayList<>();
        if(exceptions != null) {
            jvmNames = new ArrayList<>();
            for (TypeName i : exceptions) {
                jvmNames.add(i.resolve(context).jvmName());
            }
        }
        return this;
    }
    ...
    public void codegen(CLEmitter output) {
         output.addMethod(mods, "<init>", descriptor, jvmNames, false);
//        if(jvmNames != null)
//        {
           // output.addMethod(mods, name, descriptor, jvmNames, false);
//        }
//        else{
